...
bool math::wide_integer::example004_rootk_pow()
{
  ...
  {
    UINTWIDE_T_TEST_CONSTEXPR uint256_t x("0x95E0E51079E1D11737D3FD01429AA745582FEB4381D61FA56948C1A949E43C32");
    UINTWIDE_T_TEST_CONSTEXPR uint256_t r = rootk(x, 7U);

    result_is_ok_root = (r == UINT64_C(0x16067D1894));
  }

  {
    UINTWIDE_T_TEST_CONSTEXPR uint256_t r(UINT64_C(0x16067D1894));
    UINTWIDE_T_TEST_CONSTEXPR uint256_t p = pow(r, 7U);
