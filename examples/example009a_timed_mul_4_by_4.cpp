...
namespace local_timed_mul_4_by_4
{
  ...
  #if defined(WIDE_INTEGER_NAMESPACE)
  using big_uint_type = WIDE_INTEGER_NAMESPACE::math::wide_integer::uintwide_t<static_cast<WIDE_INTEGER_NAMESPACE::math::wide_integer::size_t>(UINT32_C(128)), local_limb_type>;
  #else
  using big_uint_type = ::math::wide_integer::uintwide_t<static_cast<math::wide_integer::size_t>(UINT32_C(128)), local_limb_type>;
  #endif
...
#endif
{
  ...
  while(stopwatch_type::elapsed_time<float>(my_stopwatch) < static_cast<float>(2.0L)) // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
  {
