...
bool math::wide_integer::example001a_div_mod()
{
  ...
  UINTWIDE_T_EXAMPLES_CONSTEXPR uint512_t a("698937339790347543053797400564366118744312537138445607919548628175822115805812983955794321304304417541511379093392776018867245622409026835324102460829431");
  UINTWIDE_T_EXAMPLES_CONSTEXPR uint512_t b("100041341335406267530943777943625254875702684549707174207105689918734693139781");

  UINTWIDE_T_EXAMPLES_CONSTEXPR uint512_t c = (a / b);
  UINTWIDE_T_EXAMPLES_CONSTEXPR uint512_t d = (a % b);

  UINTWIDE_T_EXAMPLES_CONSTEXPR bool result_is_ok = (   (c == "6986485091668619828842978360442127600954041171641881730123945989288792389271")
