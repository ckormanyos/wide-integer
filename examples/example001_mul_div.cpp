...
bool math::wide_integer::example001_mul_div()
{
  ...
  UINTWIDE_T_TEST_CONSTEXPR uint256_t b("0x166D63E0202B3D90ECCEAA046341AB504658F55B974A7FD63733ECF89DD0DF75");

  UINTWIDE_T_TEST_CONSTEXPR uint256_t c = (a * b);
  UINTWIDE_T_TEST_CONSTEXPR uint256_t d = (a / b);

  UINTWIDE_T_TEST_CONSTEXPR bool result_is_ok = (   (c == "0xE491A360C57EB4306C61F9A04F7F7D99BE3676AAD2D71C5592D5AE70F84AF076")
