...
// clang-tidy-12 examples/example000_numeric_limits.cpp --header-filter=uintwide_t -checks=*,-fuchsia-*,-llvmlibc-*,-llvm-header-guard,-readability-identifier-naming,-readability-avoid-const-params-in-decls -- -I. -DWIDE_INTEGER_HAS_MUL_8_BY_8_UNROLL > tidy.txt
