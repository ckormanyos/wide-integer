...
// clang-tidy examples/example000_numeric_limits.cpp --header-filter=uintwide_t -checks=-*,clang-analyzer-*,modernize*,cppcoreguidelines* -- -I. -DWIDE_INTEGER_HAS_MUL_8_BY_8_UNROLL > tidy.txt
